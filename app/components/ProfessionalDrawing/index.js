...
require( './js/main');
import {destroyCanvas,initCanvas} from './js/main';
...
class ProfessionalDrawing extends React.Component {
  ...
  componentDidMount() {
    ...
    Array.from(document.getElementsByClassName("gui"))[0].style.display ="absolute";
  ...
  componentDidUnMount() {
    ...
    Array.from(document.getElementsByClassName("gui"))[0].style.display ="none";
