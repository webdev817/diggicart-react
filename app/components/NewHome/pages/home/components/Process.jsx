...
const Process = () => {
  ...
  const boxData = [
    { color: ColorBlue, text: 'Klicka på ”Börja måla”. Använd sedan verktygen (penna, pensel, etc) för att börja måla tavlan.' },
    { color: ColorOrange, text: 'När tavlan är färdigmålad klicka på ”Skicka för tryck”.' },
  ...
  return ( <>
        ...
        <Container className='section_container'>
          <Row>
            <Col md={12} className='process_title'>
              <h2 className='process_heading'>DiggiArt är anpassat för barn i alla åldrar – se mer!</h2>
            </Col>
      ...
      <section>
        <Container className='section_container'>
          ...
          <Row>
            <Col>
              <span className='process_note'>Du kan även välja att spara målningen för tryck vid ett senare tillfälle, webbläsaren sparar pågående projekt automatiskt. När du öppnar sidan nästa gång så öppnas det senaste projektet.</span>
            </Col>
          </Row>
        </Container>
      </section>
